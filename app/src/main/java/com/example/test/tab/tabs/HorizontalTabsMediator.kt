 ...
 *
 */
class HorizontalTabsMediator(
    private val tabs: HorizontalTabs,
        ...
        if (adapter != null) {
            ...
            if (adapterCount > 0) {
                ...
                if (currItem != tabs.selectedTabPosition) {
                    tabs.selectTab(tabs.getTabAt(currItem))
                }
            }
        }
    }
     ...
     */
    private class TabLayoutOnPageChangeCallback(tabs: HorizontalTabs) :
        OnPageChangeCallback() {
        private val tabsRef: WeakReference<HorizontalTabs> = WeakReference(tabs)
        ...
        override fun onPageSelected(position: Int) {
            ...
            if (tabs != null && tabs.selectedTabPosition != position && position < tabs.tabCount) {
                ...
                tabs.selectTab(tabs.getTabAt(position), updateIndicator)
            }
        }
