...
public class VerticalTabLayout extends ScrollView {
    ...
    public int getSelectedTabPosition() {
        return getTabPosition(mSelectedTab);
    }

    public int getTabPosition(TabView tabView) {
        int index = mTabStrip.indexOfChild(tabView);
    ...
    public void setScrollPosition(int position, float positionOffset, boolean updateSelectedText, boolean updateIndicatorPosition) {
        ...
        // TODO: 8/31/21 set tab selected state based on scroll position
    }

    public void addTab(TabView tabView) {
        addTab(tabView, true, true);
    }

    public void addTab(TabView tabView, final boolean updateIndicator, final boolean callListener) {
        if (tabView != null) {
            ...
            tabView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    setTabSelected(position, updateIndicator, callListener);
                }
            });
        } else {
    ...
    public void setTabSelected(final int position, final boolean updateIndicator, final boolean callListener) {
    ...
    private void setTabSelectedImpl(final int position, boolean updateIndicator, boolean callListener) {
        ...
        if (selected = (view != mSelectedTab)) {
            ...
            lastSelectedTab = mSelectedTab;
            lastSelectedPosition = getTabPosition(lastSelectedTab);
            mSelectedTab = view;
            ...
            for (int i = 0; i < mTabSelectedListeners.size(); i++) {
                ...
                if (listener != null) {
                    if (lastSelectedTab != null) {
                        listener.onTabUnselected(lastSelectedTab, lastSelectedPosition);
                    }
                    if (selected) {
